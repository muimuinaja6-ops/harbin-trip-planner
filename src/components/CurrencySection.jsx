...
export default function CurrencySection(){
  ...
  const handleRate=e=>{const v=e.target.value.replace(/[^0-9.]/g,'').replace(/(\..*)\.$/,'$1');localStorage.setItem('harbin-rate',v);setRate(v);};
