...
const TABS=[{id:'weather',label:'อากาศ'},{id:'plan',label:'แผนเที่ยว'},{id:'route',label:'เส้นทาง'},{id:'fx',label:'แลกเงิน'},{id:'pack',label:'เตรียมตัว'},{id:'cn',label:'ภาษาจีน'},{id:'tips',label:'เทคนิค'},{id:'expense',label:'หารเงิน'},{id:'sos',label:'ฉุกเฉิน'}];
