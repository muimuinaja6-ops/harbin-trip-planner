    ...
    <div style={{padding:16,background:'#fff',border:'2px solid var(--ice)',borderRadius:18,boxShadow:'0 8px 20px rgba(60,120,180,.08)'}}>
      ...
      <div style={{marginTop:16,paddingTop:16,borderTop:'2px dashed var(--ice)'}}>
        ...
        <div style={{display:'flex',gap:8}}>
          <input value={newPhrase} onChange={e=>setNewPhrase(e.target.value)} onKeyDown={e=>e.key==='Enter'&&addPhrase()} placeholder="เช่น ขอผ้าห่มเพิ่มหนึ่งผืน" style={{flex:1,fontFamily:"'Mitr',sans-serif",fontSize:15,padding:'9px 12px',background:'#fff',border:'2px solid var(--ice)',borderRadius:14,color:'var(--navy)'}}/>
